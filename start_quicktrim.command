...
# (file:// cannot be used because browsers block media/AudioContext features there.)

# Move to the folder that contains this script, so the server serves quicktrim.html.
cd "$(dirname "$0")" || exit 1

PORT=8765
URL="http://localhost:${PORT}/quicktrim.html"
